...
# The installed program is also the discoverable Codex Skill. Keep scripts,
# assets, metadata, and runtime together so a git clone remains distributable.
INSTALL_ROOT="${CODEX_DREAM_SKIN_ROOT:-$HOME/.codex/skills/codex-dream-skin}"
